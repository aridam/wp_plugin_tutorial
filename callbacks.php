 ...
 */
function wp_plugin_tutorial_main_menu_callback() {
 ...
 * @see wp_plugin_tutorial_add_admin_menu
 */
function wp_plugin_tutorial_submenu_1_callback() {
 ...
 * @see wp_plugin_tutorial_add_admin_menu
 */
function wp_plugin_tutorial_submenu_2_callback() {
 ...
 * @see wp_plugin_tutorial_add_admin_menu
 */
function wp_plugin_tutorial_option_callback() {
 ...
 */
function wp_plugin_tutorial_greet_repeat_callback() {
